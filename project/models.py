...
class Project(models.Model):
    ...
    image_1 = models.ImageField(upload_to="project/project/images", verbose_name="تصویر 1", help_text="ضروری")
    image_2 = models.ImageField(upload_to="project/project/images", verbose_name="تصویر 2", help_text="ضروری")
    image_3 = models.ImageField(upload_to="project/project/images", verbose_name="تصویر 3", help_text="ضروری")
    image_4 = models.ImageField(upload_to="project/project/images", verbose_name="تصویر 4", help_text="ضروری")
    image_5 = models.ImageField(upload_to="project/project/images", verbose_name="تصویر 5", blank=True, null=True)
    image_6 = models.ImageField(upload_to="project/project/images", verbose_name="تصویر 6", blank=True, null=True)
    image_7 = models.ImageField(upload_to="project/project/images", verbose_name="تصویر 7", blank=True, null=True)
    image_8 = models.ImageField(upload_to="project/project/images", verbose_name="تصویر 8", blank=True, null=True)
