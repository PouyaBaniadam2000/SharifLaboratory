...
class About(models.Model):
    title = models.CharField(max_length=75, unique=True, verbose_name="تیتر", help_text="ضروری")
    body = models.TextField(max_length=300, unique=True, verbose_name="بدنه", help_text="ضروری")
