...
class Laboratory(models.Model):
    ...
    laboratory_preview = models.CharField(max_length=200, verbose_name="دید کلی درباره آزمایشگاه", help_text="ضروری")
    image_1 = models.ImageField(upload_to="laboratory/laboratory/images", verbose_name="تصویر 1", help_text="ضروری")
    image_2 = models.ImageField(upload_to="laboratory/laboratory/images", verbose_name="تصویر 2", blank=True, null=True)
    image_3 = models.ImageField(upload_to="laboratory/laboratory/images", verbose_name="تصویر 3", blank=True, null=True)
    image_4 = models.ImageField(upload_to="laboratory/laboratory/images", verbose_name="تصویر 4", blank=True, null=True)
    ...
    about_this_lab = RichTextField(max_length=1000, verbose_name="درباره این آزمایشگاه", help_text="ضروری")
