    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('landline_phone', models.CharField(blank=True, help_text='ضروری', max_length=15, null=True, unique=True, validators=[account.validators.validate_landline_phone], verbose_name='شماره تلفن ثابت')),
                ...
                ('company_name', models.CharField(blank=True, help_text='ضروری', max_length=100, null=True, verbose_name='نام شرکت')),
                ('activity_field', models.CharField(blank=True, max_length=100, null=True, verbose_name='حوزه فعالیت')),
