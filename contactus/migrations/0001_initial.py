    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('work_time', models.CharField(help_text='ضروری', max_length=200, verbose_name='ساعت کاری')),
                ...
                ('telegram', models.CharField(help_text='ضروری', max_length=150, verbose_name='تلگرام')),
                ('whatsapp', models.CharField(help_text='ضروری', max_length=150, verbose_name='واتس اپ')),
                ('eitta', models.CharField(help_text='ضروری', max_length=150, verbose_name='ایتا')),
                ('mobile_phone', models.CharField(help_text='ضروری', max_length=150, verbose_name='شماره تلفن همراه')),
                ('landline_phone_1', models.CharField(help_text='ضروری', max_length=150, unique=True, verbose_name='شماره تلفن ثابت')),
                ('landline_phone_2', models.CharField(help_text='ضروری', max_length=150, unique=True, verbose_name='شماره تلفن ثابت')),
            ],
            options={
